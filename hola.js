...
function showTraits({ champApiName, traits, targetNode }) {
  ...
  traits.split(",").forEach((element) => {
      ...
      const url="https://raw.communitydragon.org/14.3/game/";
      traitChampImg.src= url + objTraits.icon.toLocaleLowerCase().replace(".dds",".png").replace(".tex",".png");
    ...
    console.log("parent Node", targetNode.parentNode)
